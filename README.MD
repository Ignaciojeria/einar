...
#### 🔍 File structure
For example, when you generate a publisher using the `einar generate publisher publish-customer` command, Einar CLI will create a new .go file with the following structure:
