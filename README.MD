...
A Google PubSub Inbound Adapter is the same as a Google PubSub Topic Pull Subscription. To create a new Google PubSub inbound adapter, we need to execute the following command:
