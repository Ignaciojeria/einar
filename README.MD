...
Use the following command to create a new project using the official EinarCLI template:
...
To initiate a new project using a private custom template, execute the following command:
